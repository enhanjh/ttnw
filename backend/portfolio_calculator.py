...
async def get_portfolio_returns(
    ...
    assets = await models.Asset.find(models.Asset.portfolio.id == portfolio_id).to_list()
    transactions = await models.Transaction.find(models.Transaction.portfolio.id == portfolio_id).to_list()
